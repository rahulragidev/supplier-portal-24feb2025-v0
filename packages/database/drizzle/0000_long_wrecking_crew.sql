...
CREATE TABLE "payment_term_type" (
	...
	"created_by" uuid,
	"last_updated_by" uuid,
	CONSTRAINT "payment_term_type_term_code_unique" UNIQUE("term_code"),
	CONSTRAINT "payment_term_type_term_name_unique" UNIQUE("term_name")
);
--> statement-breakpoint
CREATE TABLE "role" (
	"uid" uuid PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "supplier_commercial_term" (
	"uid" uuid PRIMARY KEY NOT NULL,
	"supplier_site_term_uid" uuid NOT NULL,
...
CREATE TABLE "supplier_site" (
	...
	"created_by" uuid,
	"last_updated_by" uuid,
	CONSTRAINT "supplier_site_gst_number_unique" UNIQUE("gst_number")
);
--> statement-breakpoint
...
CREATE TABLE "supplier_site_term" (
	...
	"agreed_credit_days" integer NOT NULL,
	"lead_time_days" integer DEFAULT 0 NOT NULL,
	"sale_or_return" boolean DEFAULT false NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	"deleted_at" timestamp with time zone,
	"created_by" uuid,
...
ALTER TABLE "approval_comment" ADD CONSTRAINT "approval_comment_comment_by_user_uid_user_uid_fk" FOREIGN KEY ("comment_by_user_uid") REFERENCES "public"."user"("uid") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "approval_log" ADD CONSTRAINT "approval_log_action_by_user_uid_user_uid_fk" FOREIGN KEY ("action_by_user_uid") REFERENCES "public"."user"("uid") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "approval_responsibility" ADD CONSTRAINT "approval_responsibility_employee_user_uid_user_uid_fk" FOREIGN KEY ("employee_user_uid") REFERENCES "public"."user"("uid") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "approval_responsibility" ADD CONSTRAINT "approval_responsibility_fallback_employee_user_uid_user_uid_fk" FOREIGN KEY ("fallback_employee_user_uid") REFERENCES "public"."user"("uid") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "employee" ADD CONSTRAINT "employee_user_uid_user_uid_fk" FOREIGN KEY ("user_uid") REFERENCES "public"."user"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "employee_org_unit_role" ADD CONSTRAINT "employee_org_unit_role_employee_user_uid_user_uid_fk" FOREIGN KEY ("employee_user_uid") REFERENCES "public"."user"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "supplier" ADD CONSTRAINT "supplier_user_uid_user_uid_fk" FOREIGN KEY ("user_uid") REFERENCES "public"."user"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "supplier_commercial_term" ADD CONSTRAINT "supplier_commercial_term_supplier_site_term_uid_supplier_site_term_uid_fk" FOREIGN KEY ("supplier_site_term_uid") REFERENCES "public"."supplier_site_term"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "supplier_invitation" ADD CONSTRAINT "supplier_invitation_invited_by_employee_user_uid_user_uid_fk" FOREIGN KEY ("invited_by_employee_user_uid") REFERENCES "public"."user"("uid") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "supplier_site" ADD CONSTRAINT "supplier_site_user_uid_user_uid_fk" FOREIGN KEY ("user_uid") REFERENCES "public"."user"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "supplier_term_note" ADD CONSTRAINT "supplier_term_note_supplier_site_term_uid_supplier_site_term_uid_fk" FOREIGN KEY ("supplier_site_term_uid") REFERENCES "public"."supplier_site_term"("uid") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "supplier_term_note" ADD CONSTRAINT "supplier_term_note_created_by_user_uid_fk" FOREIGN KEY ("created_by") REFERENCES "public"."user"("uid") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "approval_process_org_name_unique" ON "approval_process" USING btree ("organization_uid","name");--> statement-breakpoint
...
CREATE UNIQUE INDEX "approval_step_process_order_unique" ON "approval_step" USING btree ("approval_process_uid","step_order");--> statement-breakpoint
...
CREATE UNIQUE INDEX "org_unit_org_name_unique" ON "org_unit" USING btree ("organization_uid","name");--> statement-breakpoint
CREATE UNIQUE INDEX "org_unit_org_code_unique" ON "org_unit" USING btree ("organization_uid","org_unit_code");--> statement-breakpoint
...
CREATE UNIQUE INDEX "role_org_name_unique" ON "role" USING btree ("organization_uid","name");--> statement-breakpoint
CREATE UNIQUE INDEX "role_org_code_unique" ON "role" USING btree ("organization_uid","role_code");--> statement-breakpoint
...
CREATE UNIQUE INDEX "store_org_name_unique" ON "store" USING btree ("organization_uid","name");--> statement-breakpoint
CREATE UNIQUE INDEX "store_org_code_unique" ON "store" USING btree ("organization_uid","store_code");--> statement-breakpoint
...
CREATE UNIQUE INDEX "supplier_org_name_unique" ON "supplier" USING btree ("organization_uid","name");--> statement-breakpoint
...
CREATE INDEX "idx_commercial_term_site_term" ON "supplier_commercial_term" USING btree ("supplier_site_term_uid");--> statement-breakpoint
CREATE INDEX "idx_commercial_term_type" ON "supplier_commercial_term" USING btree ("term_type");--> statement-breakpoint
CREATE INDEX "idx_supplier_commercial_term_deleted_at" ON "supplier_commercial_term" USING btree ("deleted_at");--> statement-breakpoint
...
CREATE UNIQUE INDEX "supplier_site_name_unique" ON "supplier_site" USING btree ("supplier_user_uid","site_name");--> statement-breakpoint
...
CREATE INDEX "idx_term_site" ON "supplier_site_term" USING btree ("supplier_site_user_uid");--> statement-breakpoint
CREATE INDEX "idx_term_effective_date" ON "supplier_site_term" USING btree ("effective_date");--> statement-breakpoint
CREATE INDEX "idx_supplier_site_term_deleted_at" ON "supplier_site_term" USING btree ("deleted_at");--> statement-breakpoint
CREATE INDEX "idx_term_note_term" ON "supplier_term_note" USING btree ("supplier_site_term_uid");--> statement-breakpoint
CREATE INDEX "idx_term_note_created_by" ON "supplier_term_note" USING btree ("created_by");--> statement-breakpoint
CREATE INDEX "idx_supplier_term_note_deleted_at" ON "supplier_term_note" USING btree ("deleted_at");--> statement-breakpoint
CREATE INDEX "idx_user_type" ON "user" USING btree ("user_type");--> statement-breakpoint
